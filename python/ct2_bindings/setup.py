...
try:
    ...
    raise RuntimeError(
        "pybind11 is required to build ct2_bindings. "
...
_extra_includes += _split_env("CT2_INCLUDE_DIR")
...
_extra_lib_dirs += _split_env("CT2_LIBRARY_DIR")
...
setup(
    name="ct2_bindings",
    version="0.1.0",
    description="pybind11 bindings around CTranslate2's Whisper model "
                "(port of speaches-plus/go/internal/stt/ct2_cgo.cc).",
