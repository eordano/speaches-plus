...
__global__ void gdn_gating_kernel_bf16(const __hip_bfloat16* __restrict__ a,
                                       const __hip_bfloat16* __restrict__ b,
                                       const __hip_bfloat16* __restrict__ A_log,
                                       const __hip_bfloat16* __restrict__ dt_bias,
                                       float* __restrict__ g_out,
                                       __hip_bfloat16* __restrict__ beta_out,
                                       size_t tokens,
                                       size_t num_heads) {
...
extern "C" int nv_kernels_gdn_gating_bf16(
    ...
    gdn_gating_kernel_bf16<<<grid, BLOCK, 0, s>>>(
        ...
        reinterpret_cast<const __hip_bfloat16*>(A_log),
        reinterpret_cast<const __hip_bfloat16*>(dt_bias),
        g_out,
        reinterpret_cast<__hip_bfloat16*>(beta_out),
        tokens, num_heads);
